function dYout = woundhealingequations2(t,yin,Z,Param)
...
%  tintervention = 168;
%  tinterventionend = 336;
%  if t>tintervention && t<tinerventionend
%      Param(10)  =Param(10)/2;
%      Param(56) = Param(56)*2;
%  end
...
dtgfdt = Param(2)*P+Param(11)*Mpro+Param(12)*Manti+Param(98)*mechstrain_tgfbeta(Mstrain)*(F+2*myoF)-Param(13)*tgf; %ng mL-1 hr-1
...
dFGF2dt =Param(78)*Mpro+Param(43)*Manti-Param(79)*fgf2;%ng mL-1 hr-1
...
dANG2dt = Param(116)*fdn_ANG2_IL6(IL6)*fdn_ANG2_TNF(tnf)*EC+Param(117)*F-Param(118)*ANG2;%ng mL-1 hr-1*fup_ANG2_VEGF*fdn_ANG2_IL6(IL6)*fdn_ANG2_TNF(tnf)
