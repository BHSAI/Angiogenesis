...
kontnf = 0.93;%2e-1;%nM-1h-1 P160
konIL8 = 3.25;%2e0;%nM-1h-1 P161


ki_tnf = 4.69;% h-1 P162
ki_IL8 = 0.830;% h-1 P163
...
kVEGF_anti = 3.0e-7/3;%/3%P110 *Changed*
...
%TSP-1
kTSP1_P = 0.5;%1;%-0.95;%P119 %used as HBOT parameter
kTSP1_pro = 6e-5;%P120
...
kapop_EC = 0.09*1.2;%*1.1;  %h-1%P138 
...
%Inhibitor
kontgf = 13.35;%nM-1h-1 P160
ki_tgf = 0.00123;% h-1 P161
...
KGF_init = 0;
CXCL1_init = 0;
Itgf_init = 0;%[0.001 0.01 0.1 1 10];% Input for TGF-beta inhibitor (nM)
I_tgf_init = 0;
...
%   VEGF_init EC_init ANG1_init ANG2_fib_init TSP1_init endo_init captip_init capsprout_init O_init];
yinit = [Nact_init Napop_init Mpro_init Manti_init tgf_init pdgf_init tnf_init IL1_init IL6_init IL10_init P_init IL8_init IL12_init MIP1_init MIP2_init IP10_init F_init myoF_init fibnec_init fgf2_init mmp9_init timp_init coll_init mmp1_init mmp2_init col1_fib_init mcp1_init intermed_init...
